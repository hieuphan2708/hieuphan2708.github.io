...
{% include img/full-normal.html src="/img/post/chuyende/kt4.png" des="Cận lâm sàng đánh giá khó thở" %}

### SpO<sub>2</sub>

<div class="row align-items-center img-aside">
<p class="col-md-6" markdown="1">
![pulse oximetry](/img/post/chuyende/kt5.png)
</p>
<p class="col-md-6" markdown="1">
Một số hạn chế của đo SpO<sub>2</sub>: khi sóng xung có biên độ thấp (hạ thân nhiệt, giảm thể tích tuần hoàn) có thể không có kết quả; bất thường Hb (carboxyhemoglobin, methemoglobin) cũng làm kết quả không chính xác.
</p>
</div>

<div class="alert alert-warning" role="alert">
  Một số yếu tố có thể ảnh hưởng đến độ chính xác của pulse oximetry và điều quan trọng là phải nhận thức được những hạn chế của nó.
</div>

### Khí máu động mạch
- Đánh giá suy hô hấp và tình trạng toan kiềm.
- Nên làm khí máu động mạch ở những trường hợp sau:
	- Đo pulse oximetry thấy giảm oxy mô có ý nghĩa.
	- Trường hợp nếu đo pulse oximetry là không chính xác (ở trên).
	- Đánh giá d(A-a), đặc biệt khi nghi ngờ PE.
	- Nghi ngờ bất thường PaCO<sub>2</sub>.
	- Định lượng carboxyhemoglobin/methemoglobin là bắt buộc.

- Ưu tiên khí máu tĩnh mạch, mao mạch trong những trường hợp sau:
	- Đánh giá toan kiềm (pH, bicarbonate, kiềm dư)
	- Định lượng lactate - để đánh giá tưới máu mô

### Xquang ngực    
{% include img/full-normal.html src="/img/post/chuyende/kt6.png" des="Dấu hiệu Xquang ở các bệnh gây khó thở" %}

### ECG
- Bệnh sử liên quan đến đau ngực do thiếu máu cơ tim mà ACS có thể giải thích được bệnh cảnh.
- Các triệu chứng và dấu hiệu của suy tim (ví dụ phù phổi) ở những người có thể bị nhồi máu cơ tim cấp hoặc thay đổi kiểu thiếu máu cục bộ cũ vì bệnh nhân bị suy tim hiếm khi có ECG bình thường.
- Khi nghi ngờ PE vì ECG căng thất phải có thể hỗ trợ chẩn đoán.
- Các triệu chứng và dấu hiệu gợi ý viêm màng ngoài tim biến chứng chèn ép tim.
- Bệnh cảnh COPD tìm tăng áp phổi hoặc cor pulmonale.
