...
<div class="alert alert-dark" role="alert">
  Khi rung nhĩ tiếp tục kéo dài hơn 48 giờ, việc phục hồi nhịp xoang có nguy cơ đánh bật huyết khối từ tiểu nhĩ trái. Trong trường hợp này, điều trị được giới hạn trong việc xác định nguy cơ đột quỵ và kiểm soát tần số thất.
</div>
...
{% include img/full-normal.html src="/img/post/chuyende/Screenshot_25.png" %}
  BN tần số thất không phải lúc nào cũng trụy huyết động nhanh chóng (chưa đến mức điều trị cấp cứu). BN có đường dẫn truyền phụ có tần số thất rất cao (> 200 bpm) với hậu quả là giảm rõ việc đổ đầy thất và cung lượng tim. Rung nhĩ sau MI thường tự giới hạn. 
</div>
</div>
