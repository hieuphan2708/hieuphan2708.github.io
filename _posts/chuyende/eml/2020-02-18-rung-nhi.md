...
- Cân nhắc khử rung bằng thuốc hoặc bằng điện tùy thuộc vào hoàn cảnh lâm sàng và nguồn lực:
	...
	- Dược lý: Flecainide có tỷ lệ thành công cao nhất liên quan đến phục hồi nhịp xoang và khởi phát nhanh hơn đáng kể so với amiodarone, tuy nhiên nó chống chỉ định ở bệnh nhân mắc bệnh thiếu máu cơ tim cục bộ hoặc bệnh tim cấu trúc. Khi tiến hành khử rung bằng thuốc:
...
{% include img/full-normal.html src="/img/post/chuyende/Screenshot_24.png" %}
  Đối với một bệnh nhân bị rung nhĩ, điều mong muốn là khôi phục nhịp xoang trong 48 giờ (từ khi khởi phát). Trong trường hợp này, không cần can thiệp trong bệnh viện nữa. Dùng thuốc kháng đông đường uống nếu:<br>Nhịp xoang không được khôi phục trong 48h HOẶC<br>  
</div>
</div>
